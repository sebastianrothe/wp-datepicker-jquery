...
describe('a dataprovider', () => {
  ...
  before(() => {
    ...
    expect(config.dataApi).to.equal("//gruseltour-berlin.de/wordpress/wp-content/themes/gruseltour-berlin-eighteen/data/data.txt")
  })
  ...
  it('should return fetch data', () => {
    ...
    requests[0].respond(200, { "Content-Type": "application/txt" }, data.join('\n'))
